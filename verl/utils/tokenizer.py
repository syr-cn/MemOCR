...
def hf_processor(name_or_path, **kwargs):
    ...
    try:
        max_pixels_28_28 = os.environ.get("MAX_PIXELS_28_28", None)
        min_pixels_28_28 = os.environ.get("MIN_PIXELS_28_28", None)
        print(f"max_pixels_28_28: {max_pixels_28_28}, min_pixels_28_28: {min_pixels_28_28}")
        if max_pixels_28_28 is not None:
            kwargs["max_pixels"] = int(max_pixels_28_28) * 28 * 28
        if min_pixels_28_28 is not None:
            kwargs["min_pixels"] = int(min_pixels_28_28) * 28 * 28
    ...
    print(f"Created processor: {processor.__class__.__name__}", flush=True)
