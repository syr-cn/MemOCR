...
First output your thinking process in plain text, then output the HTML draft in format of ```html xxx ```.
"""
...
class MemoryAgent(RAgent):
    ...
    def end(self, triple_answer_turn=False):
        ...
        if triple_answer_turn:
            ...
            all_gap_fill_qas = [make_gap_question_from_html(memory_html_text, is_md_input=False) for memory_html_text in all_memory_text]
